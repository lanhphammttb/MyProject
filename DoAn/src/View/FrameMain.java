...
import static Controller.CUsers.username;
...
public class FrameMain extends javax.swing.JFrame {
	...
	public FrameMain() {
		initComponents();
		if (!Controller.CUsers.isAdmin()) {
			userMenu.setEnabled(false);
			menuNhanVien.setEnabled(false);
                        menuSanPham.setEnabled(false);
    ...
    private void initComponents() {
        ...
        setIconImage(Toolkit.getDefaultToolkit().getImage(FrameLogin.class.getResource("/Images/Hinhnentrasua.jpg")));
        ...
        jLabel11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/quantrasua.png"))); // NOI18N
        ...
        PanelChinh.add(jLabel7, java.awt.BorderLayout.PAGE_END);
        ...
        menuTKNhanVien.setText("Doanh thu nhân viên");
        ...
        menuTKKhachHang.setText("Doanh thu khách hàng");
        ...
        menuTKSanPham.setText("Doanh thu sản phẩm");
        ...
        menuTKDoanhThu.setText("Doanh thu ngày tháng năm");
        ...
        jMenu1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/tk32.png"))); // NOI18N
        jMenu1.setText("Doanh số");
    ...
    private void menuTKNhanVienActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuTKNhanVienActionPerformed
		...
		PanelChinh.add(new PanelTKDoanhThuNhanVien(), BorderLayout.CENTER);
		PanelChinh.updateUI();
    ...
    private void menuTKKhachHangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuTKKhachHangActionPerformed
		PanelChinh.removeAll();
		PanelChinh.add(new PanelTKDoanhThuKhachHang(), BorderLayout.CENTER);
		PanelChinh.updateUI();
    ...
    private void menuTKSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuTKSanPhamActionPerformed
		PanelChinh.removeAll();
		PanelChinh.add(new PanelTKDoanhThuSanPham(), BorderLayout.CENTER);
		PanelChinh.updateUI();
    ...
    private void menuTKDoanhThuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuTKDoanhThuActionPerformed
		PanelChinh.removeAll();
		PanelChinh.add(new PanelTKDoanhThuNgayThangNam(), BorderLayout.CENTER);
		PanelChinh.updateUI();
